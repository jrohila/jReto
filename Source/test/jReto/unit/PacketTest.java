...
public class PacketTest {
    ...
    static class TestPacket implements Packet {
        ...
        public static TestPacket deserialize(ByteBuffer data, PacketType expectedType, int expectedLength) {
            ...
            if (!DataChecker.check(reader, expectedType, expectedLength)) {
                return null;
            }
    ...
    public void testPacketInvalidLength1() {
        ...
        assertEquals("Basic data check failed: Not enough data remaining. Needed: 20, available: 10"+System.lineSeparator(), outContent.toString());
    }
    ...
    public void testPacketInvalidType() {
        ...
        assertNull(packet);
        assertEquals("Basic data check failed: Unexpected type. Expected: CLOSE_REQUEST. Received: DATA_PACKET"+System.lineSeparator(), outContent.toString());
    }
}
